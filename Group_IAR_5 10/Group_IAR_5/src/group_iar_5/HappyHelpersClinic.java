...
//        Scanner input2 = new Scanner(System.in);
        ...
        int total_number_of_Offers = input.nextInt();
        ...
        while (input.hasNext()) {
            ...
            if (command.equalsIgnoreCase("SignUp_patient")) {
                SignUp_Patient(patients_array, input, output);
            } else if (command.equalsIgnoreCase("SignUp_Doctor")) {
                SignUp_Doctor(doctors_array, input, output);
            } else if (command.equalsIgnoreCase("SignUp_Nurse")) {
                SignUp_nurse(nurses_array, input, output);
            } else if (command.equalsIgnoreCase("Show_Appointment")) {
                Show_Appointment(appointments_array, doctors_array, input, output);
...
//        OffersMenu(input2);
     ...
     */
    public static void SignUp_Patient(Patient[] patients_array, Scanner input, PrintWriter output) {
        output.println("----------------------");
        System.out.println("----------------------");
        output.println("\n--->>  Add Patient\n");
        System.out.println("\n--->>  Add Patient\n");
