...
//        }
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    do {
                        BookAppointment(appointments_array, doctors_array, input2, input3);

                        choice2 = input.nextInt();
                        switch (choice2) {
                            case 1:
                                System.out.println("book for dentist");
                                AppointmentDEPdentis(appointments_array, doctors_array, input3);
                                break;
                            case 2:
     ...
     */
    public static void Show_Appointment(Appointment[] appointments_array, Doctor[] doctors_array, Scanner input) {
...
//                        + " is available now.");
    ...
    public static void checkofBookAppointmentAvalibility(Appointment[] appointments_array, Patient[] patient_array, Scanner input, PrintWriter output) {
    ...
    public static void checkofCancellAppointment() {
